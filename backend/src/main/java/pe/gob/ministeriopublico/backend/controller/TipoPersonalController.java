...
public class TipoPersonalController {
    ...
    public TipoPersonalController(TipoPersonalService service){ this.service = service; }

    @GetMapping
    public List<TipoPersonal> list(){ return service.findAll(); }
    ...
    @PostMapping
    public TipoPersonal create(@RequestBody TipoPersonal d){ return service.save(d); }
