...
public class EquipoController {
    ...
    @GetMapping
    public List<Equipo> list(){ return service.findAll(); }
    ...
    @PostMapping
    public Equipo create(@RequestBody Equipo d){ return service.save(d); }

    @PutMapping("/{id}")
    public ResponseEntity<Equipo> update(@PathVariable Integer id, @RequestBody Equipo d){
        return service.findById(id).map(existing -> {
            d.id_equipo = existing.id_equipo;
